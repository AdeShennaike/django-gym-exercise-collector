"""
Django settings for gymexercisecollector project.
...
SECRET_KEY = 'django-insecure-$i_+tim^zv_@fxh^%2ri-hxtdx#ua^gyotmwjwm(#hltpy-3x0'
...
ROOT_URLCONF = 'gymexercisecollector.urls'
...
WSGI_APPLICATION = 'gymexercisecollector.wsgi.application'
